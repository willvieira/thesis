...
par
\\   \vspace{2.5cm}
{\textbf{[Prénom et nom]}} % inscrire votre nom
\\   \vspace{2.5cm}
...
\setstretch{1.3}\input{chapter1/manuscript_thesis}
\setstretch{1.3}\input{chapter2/manuscript_thesis}
\setstretch{1.3}\input{chapter3/manuscript_thesis}
...
\setstretch{1.3}\include{annexe1}       
\setstretch{1.3}\include{annexe2} 
